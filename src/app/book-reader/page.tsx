...
const bookContent = [
    ...
    "A blazing sun on a fierce August day was hardly a novelty in southern France, then or now. Everything in and around Marseilles seemed to be locked in a staring contest with the fervent sky.",
    "Newcomers found themselves unnerved by the glaring white houses, the stark white walls, and the blinding white streets. The parched roads and hills, stripped of greenery, all stared back. Only the vines, heavy with grapes, offered some relief; they seemed to wink, their leaves barely stirring in the hot, still air.",
    "There wasn't a breath of wind to disturb the foul water of the harbour, nor the beautiful sea beyond. A distinct line separated the black of the port from the blue of the ocean, a boundary the pure sea refused to cross. It lay just as placid as the wretched pool it would not touch.",
    "Boats without awnings were too hot to handle, ships blistered at their moorings, and the quay stones had been relentlessly hot for months. People from every corner of the globe sought refuge in any available shade, hiding from a sea too intensely blue to gaze upon and a sky of deep purple, dominated by the fiery jewel of the sun.",
    "The relentless glare made one's eyes ache. Far off, towards the Italian coast, a light mist rising from the sea offered a slight reprieve, but there was no other softness to be found. The dusty roads stared from the hillsides and the plains.",
    "The vines overhanging the wayside cottages and the monotonous rows of parched trees drooped under the oppressive gaze of earth and sky. It was the same for the horses, their drowsy bells jingling as they pulled long carts inland, and for their drivers, who were rarely awake.",
    "Even the labourers in the fields were exhausted. Everything that lived and grew was oppressed by the glare—except for the swift lizards on the stone walls and the cicadas, whose dry, hot chirp was like a constant rattle. The very dust was scorched brown, and the air itself seemed to pant.",
    "Blinds, shutters, and curtains were all drawn to keep out the light. If it found even a keyhole, it shot through like a white-hot arrow. The churches offered the best escape.",
    "To step out from their cool, dim interiors—filled with dozing, begging shadows—was to dive into a river of fire, swimming for your life towards the nearest sliver of shade.",
    "So, with people lounging wherever they could find cover, a low hum of chatter, and the occasional clang of church bells, Marseilles lay broiling in the sun.",
    "In Marseilles that day, there was a dreadful prison. In one of its cells, a place so grim that even the sun shied away, were two men. Besides them, the room held only a scarred bench fixed to the wall, a couple of mats, and a few empty wine bottles. That was all, aside from the rats and other unseen vermin.",
    ...
    "A prison's taint was on everything. The air, the light, the dampness, the men themselves—all had deteriorated from confinement. Just as the men were faded and gaunt, the iron was rusty, the stone was slimy, and the wood was rotten.",
    "Like a tomb, the prison knew nothing of the world's brightness and would have kept its polluted atmosphere even in the heart of a tropical paradise.",
    ...
    "'How can I say? I just do. I know the hour, and I know where I am. They brought me here at night, from a boat, but I know this place. See?' he said, kneeling and mapping out the area with a grimy finger.",
    "'Marseilles harbour. Over there, Toulon, where the galleys are. Spain, further on. Algiers, across the water. To the left, Nice. Then round to Genoa, and... ah, no room for Naples,' he said, reaching the wall. 'But it's in there somewhere!'",
